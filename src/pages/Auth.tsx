    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gradient-to-br from-primary/5 to-accent/10">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-primary">NewsIQ</h1>
          <p className="text-muted-foreground">Smarter news, personalized for you</p>
        </div>

        <Card>
          <CardHeader>
            <CardTitle>Welcome to NewsIQ</CardTitle>
